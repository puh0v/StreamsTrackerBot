...
/**
 * Получает апдейт от UpdateReceiver, собирает всю необходимуб информацию
...
public class CommandsService {
    ...
    /**
     * Данный метод получает апейдт от UpdateReceiver, собирает всю нуобходимую информацию
